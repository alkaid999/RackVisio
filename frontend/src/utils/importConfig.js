...
export const rackImportConfig = {
  ...
  fields: [
    ...
    { key: 'design_power', label: '设计功率', required: false, type: 'number', hint: 'W，机柜额定功率上限' },
...
export const deviceImportConfig = {
  ...
  fields: [
    ...
    { key: 'rated_power', label: '额定功率', required: false, type: 'number', hint: 'W，厂家铭牌满载功率' },
    { key: 'model', label: '型号', required: false },
    { key: 'device_code', label: '设备编号', required: false, hint: '留空自动生成' },
    { key: 'sn', label: '序列号', required: false },
    { key: 'ip_address', label: '业务IP地址', required: false, hint: '需带 CIDR，如 1.2.3.4/24' },
    { key: 'oob_ip', label: '带外管理IP', required: false, hint: '需带 CIDR；同一设备可与业务IP相同' },
